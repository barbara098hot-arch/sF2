      ...
      <section className="py-20 bg-fiorella-black px-4">
         <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link to="/catalogo?cat=Lingerie" className="relative h-[400px] overflow-hidden group">
              <img src="https://images.unsplash.com/photo-1582042125584-3c8c6f116dc2?q=80&w=800&auto=format&fit=crop" className="w-full h-full object-cover opacity-50 group-hover:opacity-70 transition-opacity duration-500" alt="Lingerie" />
            ...
            <Link to="/catalogo?cat=Produto%20Erótico" className="relative h-[400px] overflow-hidden group">
              <img src="https://images.unsplash.com/photo-1629853381488-81f1d1fc5521?q=80&w=800&auto=format&fit=crop" className="w-full h-full object-cover opacity-50 group-hover:opacity-70 transition-opacity duration-500" alt="Produtos Eróticos" />
              <div className="absolute inset-0 flex flex-col items-center justify-center">
