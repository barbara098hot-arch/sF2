    ...
    <footer className="bg-fiorella-footer border-t border-[#222] py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-center md:items-end text-center md:text-right">
          ...
          <p className="text-sm text-fiorella-light-cream/70 mb-2">Seg - Sáb | 9h às 18h</p>
          <div className="flex space-x-4 mt-4">
            <a href={`https://wa.me/${config.whatsapp}`} target="_blank" rel="noreferrer" className="text-fiorella-gold hover:text-fiorella-light-cream transition-colors">
